// The template to connect a WebApp to a Storage Account with Service Connector
// =======================================================
//   Source         :   Webapp
...
module serviceConnectorDeployment '../../../dependency_modules/connectors/webapp_connector.bicep' = {
  ...
  params: {
    ...
    connectorTargetResourceId: storageAccountDeployment.outputs.id
    connectorAuthType: 'secret'
  }
}
